...
public enum EtatPates { Fixe = 0, Positif = 1, Negatif = -1 };

public class RotationPates : MonoBehaviour
{

    public EtatPates rotationEtat = EtatPates.Fixe;
    ...
    void FixedUpdate()
    {
        if (rotationEtat != EtatPates.Fixe)
        {
